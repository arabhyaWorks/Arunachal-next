...
export default function Foods({ data }) {
  const foods = data[0]["categories"]["Foods of the tribes"];
  console.log(data[0]["categories"]["Foods of the tribes"]);
  return (
    <div
      id="cuisine"
        ...
        {foods.map((dish, index) => (
          ...
          >
            <div className="aspect-[4/3] rounded-t-xl overflow-hidden relative">
              <img
                src={
                  dish.attributes["cat-FoodsOfTheTribes-BannerImageOfTheFood"]
