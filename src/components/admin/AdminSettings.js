...
export default function AdminSettings() {
  // Introduce a mounted state to avoid using localStorage during SSR.
  ...
  // On mount, update the mounted state and set dark mode based on localStorage.
  useEffect(() => {
    setMounted(true);
  ...
  // Until the component mounts, return null to avoid SSR/CSR mismatches.
  if (!mounted) {
    return null;
  }
